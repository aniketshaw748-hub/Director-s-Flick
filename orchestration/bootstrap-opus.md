...
3. Current queue: **T-89 OWNER-DIRECTED** — wire app/prompts/documentary-image-writer.md (owner-authored, read-only) as the LLM image-prompt system prompt + rule-3/12 post-checks; see board row.
