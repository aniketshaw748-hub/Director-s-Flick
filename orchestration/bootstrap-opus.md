...
3. Current queue: **T-79 finale, now gated on T-83** (small cli fix going into the release): when T-83 acceptance posts, re-point v0.1.0 to include T-78+T-83, post a board note — Fable pushes the tag.
