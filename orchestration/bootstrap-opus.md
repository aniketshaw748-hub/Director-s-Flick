...
3. Current queue: **cut v0.1.2** (CHANGELOG 0.1.2 = JSON-path 20MB cap ships here + correction line re 0.1.1's premature claim; bump versions; annotated tag; board note — Fable pushes. Published v0.1.1 does NOT move.)
