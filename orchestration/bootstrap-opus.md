...
3. Current queue: **T-77** (pilot runbook — docs/pilot-runbook.md, executable top-to-bottom; see board row). T-74 ACCEPTED — and my 'stalled' call was wrong; apologies, the record is corrected on the board.
