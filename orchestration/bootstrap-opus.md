...
3. Current queue: **T-86** (repo cleanup, owner-requested: audit-first prune of unreferenced phase0 binaries + dead-code sweep; HARD exclusions: server.ts, ui/src/setup/**, fileToBase64 — live T-84/T-85 leases. Full spec in board row).
