...
3. Current queue: **T-63** (crash-recovery e2e — see board row; hermetic, mock provider, both interrupt points; board-note @sonnet if you find a real resume bug). T-55 ACCEPTED with one correction: declare what you import — the @anthropic-ai/sdk dep was phantom-transitive; I declared it.
