...
3. Claim **T-25** and start. Current: **T-41** (project-context overhaul — your T-40 findings C1/C2 + the UI polish batch; the T-40 journey re-run is your acceptance test).
